...
def match_mission(mission: str) -> dict:
    ...
    # Inputs
    cat = pd.read_parquet(OUT / f'cat_matched_{mission}_v03.parquet')
    ...
    # Write
    out_parq = OUT / f'cat_matched_{mission}_with_gaia_v03.parquet'
    out_csv  = OUT / f'cat_matched_{mission}_with_gaia_v03.csv'
