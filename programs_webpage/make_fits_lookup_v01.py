...
Input:  csvfiles_sn/sn_candidates_v01.parquet   (1,117,776 rows)
Output: csvfiles_sn/fits_lookup_v01.parquet     (same rows)
        csvfiles_sn/fits_lookup_v01_summary.txt
...
IN_PATH  = Path("/Users/suzuki/github/projects_cosmos/csvfiles_sn/sn_candidates_v01.parquet")
OUT_DIR  = Path("/Users/suzuki/github/projects_cosmos/csvfiles_sn")
OUT_PARQ = OUT_DIR / "fits_lookup_v01.parquet"
OUT_LOG  = OUT_DIR / "fits_lookup_v01_summary.txt"
